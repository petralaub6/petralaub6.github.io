...
const szuletesnap_1 = require("./szuletesnap");
const szuletesnapKezelo_1 = require("./szuletesnapKezelo");
let szuletesnap1 = new szuletesnap_1.szuletesnap("Petra 25. születésnapja", "Balatonfüred", "2026-09-29", szuletesnapTipus_1.szuletesnapTipus.csaladi);
let szuletesnap2 = new szuletesnap_1.szuletesnap("Tamás 28. születésnapja", "Törökbálint", "2026-09-05", szuletesnapTipus_1.szuletesnapTipus.felnott);
let szuletesnap3 = new szuletesnap_1.szuletesnap("Luca 30. születésnapja (meglepetés)", "Érd", "2026-10-03", szuletesnapTipus_1.szuletesnapTipus.meglepetes);
...
let kezelo = new szuletesnapKezelo_1.szuletesnapKezelo();
kezelo.szuletesnapHozzaadas(szuletesnap1);
kezelo.szuletesnapHozzaadas(szuletesnap2);
kezelo.szuletesnapHozzaadas(szuletesnap3);
kezelo.szuletesnapSzerkesztes("Tamás 28. születésnapja", "Tamás 28. születésnapja", "Törökbálint", "2026-09-12", szuletesnapTipus_1.szuletesnapTipus.felnott);
kezelo.szuletesnapTorles("Luca 30. születésnapja (meglepetés)");
kezelo.tipusSzerintiKereses(szuletesnapTipus_1.szuletesnapTipus.csaladi);
...
console.log("Típus: " + szuletesnapTipus_1.szuletesnapTipus[szuletesnap1.tipus]);
